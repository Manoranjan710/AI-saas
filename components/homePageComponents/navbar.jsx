        ...
        <div className="flex justify-between items-center h-16">
          ...
          <Link href="/" className="flex items-center">
            <div className="flex items-center space-x-2 py-3">
                <Image alt="logo" src={require("@/public/icons/gen_logo.svg")} width={40} height={40} />
                <div>
                <h2 className="text-white font-bold text-xl">Gen 1.</h2>
                <p className="text-white text-[12px] opacity-50"> by DesignPad.</p>
                </div>
            </div>
          </Link>
          ...
          <div className="flex items-center space-x-4 text-[16px]">
            ...
            <button className="bg-[#5552FF] text-white px-4 py-2 rounded-full hover:shadow-lg transform hover:-translate-y-0.5 transition-all duration-200">
              Sign Up
            </button>
          </div>
